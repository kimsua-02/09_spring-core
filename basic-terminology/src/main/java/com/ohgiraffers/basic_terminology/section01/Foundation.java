...
public class Foundation {
    ...
    * 2. 취미
    * 3. 본인의 장단점
    * 4. 회사에 노실력 예스인성, 노인성, 예스실력이라는 사람이 있다면 어떤 분을 선택할 것인가
    * 5. 여행 일정이 있는데 프로젝트 마감 기한과 겹칠 경우 어떻게 할 것인가
    * 6. 프로젝트를 진행할 때 힘들었던 점
    *
    * <기술 면접>
    * 1. MSA 에 대해 알고 있는 것들
    * 2. SQL 실행 순서
    ...
    * 5. 기업에서 오라클을 사용하는 이유
    * 6. 비동기 통신이란 무엇인가
    * 7. 자바 스크립트 콜백 함수는 무엇인가 / 콜백 지옥 벗어나는 방법
    * 8. MVC 모델에 대해 설명
    * 9. 싱글톤 패턴에 대해 알고 있는지
    * 10. 변수의 종류
    * 11. 객체지향 프로그래밍이란 무엇인가
    * 12. 클래스와 객체에 대해
    * 13. 오버라이딩이란 무엇인가
    * 14. wrapper 클래스에 대해 설명
    * 15. String 은 기본자료형인가
    * 16.
    * */
